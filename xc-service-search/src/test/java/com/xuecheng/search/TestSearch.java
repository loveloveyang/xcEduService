...
public class TestSearch {
    ...
    public void testMatchQuery() throws IOException, ParseException {
        ...
        //搜索方式,分词匹配
        //MatchQuery,“spring开发框架”会被分为三个词：spring、开发、框架，
    ...
    public void testMultiMatchQuery() throws IOException, ParseException {
        ...
        //搜索方式
        //MultiMatchQuery,拿关键字 “spring css”去匹配name 和description字段。
        //通过postman查询发现Bootstrap排在前边。
    ...
    public void testBoolQuery() throws IOException, ParseException {
        ...
        //提升boost，通常要求关键字匹配上name的权重要比匹配上description的权重高，这里可以对name的权重提升。
